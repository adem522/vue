<template>
<modal name="demo-register" @before-open="beforeOpen" transition="pop-out" :width="modalWidth" :focus-trap="true" :height="400">
  <div class="box">
    <sign-modal /> 
...
import SignModal from './SignIn.vue'
export default {
  name: 'RegisterModal',
  components:{
    SignModal,
...
.box {
  ...
  .box-part {
    ...
    &#bp-right {
      background: url('../assets/panorama.jpeg') no-repeat top left;
